//
//  signuserimageViewController.swift
//  Login
//
...
class signuserimageViewController: UIViewController {
 @IBOutlet weak var collectionView: UICollectionView!
    ...
    @IBAction func signin(_ sender: UIButton) {
        let registerPage = self.storyboard?.instantiateViewController(withIdentifier: "homePageViewController") as! homePageViewController
